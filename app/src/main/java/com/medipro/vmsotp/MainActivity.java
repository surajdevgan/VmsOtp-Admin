...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getLogoutdata();
        Log.w("MobileNoDiValueLogin",loginph);
        ...
        cardViewButton.setOnClickListener(view -> {
            ...
            if (ConnectionCheck.isConnected(connectivityManager, networkInfo, MainActivity.this)) {
                if (isVarified()) {
                    ...
                    Log.w("eh value dekh", ""+printCount);
    ...
    void uploadDetails() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Util.updateAndInsert, response -> {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.w("this is balance jahera ubser enter kr reha",""+BalanceCount);
...
// this else is for permission already granted
    ...
    public static void main(String[] args) {
        String logoutkenwalaphone = "8888888888";
        String loginph = "7777777777,8888888888,55555,88888,9999999";
        String[] otp = loginph.split(",");

        List<String> otpList = new ArrayList<>(Arrays.asList(otp));
        if (otpList.contains(logoutkenwalaphone)) {
            otpList.remove(logoutkenwalaphone);
            System.out.println("loginph removed from otp array");
        }
